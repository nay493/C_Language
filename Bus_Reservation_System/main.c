...
#include <stdlib.h>
#include <string.h>
char ch[10][130]={"gujarat Express","Maharastra Express","saurastra Express","goa Express","kashmir Express","somnath Express"};
char name[32][100]={'\0'};
char number[32][2]={'\0'};
int num1[32]={0};
int trno;
...
int main()
{
    ...
    system("cls");
    printf("\n\n\n");
   printf("*************************************** Welcome to Digital Bus station *************************************\n\n\n");
    printf("\t\t\t\t1\t\tFor Bus list\n");
    printf("\t\t\t\t2\t\tFor Booking tickets\n");
    printf("\t\t\t\t3\t\tCancle Booking\n");
    printf("\t\t\t\t4\t\tBus status Bord\n");
    printf("\t\t\t\t5\t\tExit\n\n");
...
getch();
    ...
    printf("\t----------------------------------------------------------------------------------------------------------\n");
    printf("\t\t\t\t\t\tThank you for Bus reservation\t\t\t\t\t\t\n");
    printf("\t----------------------------------------------------------------------------------------------------------\n");
    getch();
    return 0;
}
...
fclose(b);
 ...
 printf("Your 200 rupees are being Return");
}
